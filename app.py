...
from view_point_in_time.pit_synch import make_concordance_figure, half_donut_segments
...
# Color Scheme for the App
    ...
    # Parent/Adult and Child Colors
        ...
        # rgb (35,119,180 )     # dark blue     (adult/parent)
...
FIG_SYNCH_GLYPH        = make_concordance_figure(df)
    ...
    if not show_pit:
        return html.Div(
            style={
                "display": "grid",
                # 3 columns:
                #  - col1 + col2 for big summary
                #  - col3 for right-side cards
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        chart_header(
                            title="Physiological Concordance Summary",
                            index="synch-summary",
                            body=(
                                "This panel displays who led concordant moments and the distribution of concordance strength ",
                                "from the recorded session. The top bar chart indicates how many times each participant led a concordant",
                                " moment in both low and high-frequency concordance (with a cutoff magnitude of 0.5). If there is no data for a participant, it means",
                                " they did not lead a moment of concordance for that frequency. Clicking on a participant's bar will filter ",
                                "the visuals for percent of time in joint engagement and concordance magnitude distributions by concordances (low or high) led by the selected participant.",
                        ...
                        html.Div(
                            ...
                            children=[
                                chart_header(
                                    ...
                                    index="summary-table",
                                    body=(
                                        "This table provides a takeaway summary of the session data, including the total number of concordance ",
                                        "moments, the average duration of each concordance moment, the number of moments of engagement (including both coordinated and",
                                        " supported joint engagement), and the average duration of engagements. A threshold of 0.5 was used to discern concordant versus ",
                                        "non-concordant moments."
                                    ),
                                ),
                                html.Div(
                                    id="summary-table",
                ...
                html.Div(
                    ...
                    children=[
                        chart_header(
                                title="Parent-Child Session Data of Physiological Concordance, Leading Behavior, and Engagement",
                                index="vid-heatmaps",
                                body=(
                                    ...
                                    " (such as the magnitude of concordance) at one second. The timestamps displayed at the bottom correspond to the video",
                                    " timestamps from the recording session. Clicking once on the stacked heatmaps will open a one-minute interval window ",
                                    "that filters the data displayed in concordance magnitude distributions and percent of time in joint engagement.",
                                    " When Point-in-time views is enabled, the black vertical line will also update the position of the point-in-time physiological concordance and ",
    ...
    return html.Div(
        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    chart_header(
                            title="Point-in-Time Physiological Concordance",
                            index="pit-concordance",
                            body=(
                                "The dual radial bar charts depict the magnitude of low frequency concordance and high ",
                                "frequency concordance at each second in the data. The time at which the data is displayed is updated by the black cursor bar ",
                                ...
                                "radial bar charts show the concordance magnitudes at the first second of the collected data.",
                                " Both the length and color of the bars indicate the magnitude of concordance - short, lighter bars represent a lack of concordance, bars that reach a bluish tint ",
                                "at the midway point represent weaker concordance, and very long bars reaching a deep purple represent stronger concordance. "
                            ),
                    ),
                    html.Div(
                        style={
                ...
                children=[
                    chart_header(
                            ...
                            body=(
                                ...
                                " and displays what type of engagement (if any) is occurring at the selected time. The right icon under Leading Physiologic Concordance is ",
            ...
            html.Div(
                ...
                children=[
                    chart_header(
                            title="Physiological Concordance Summary",
                            index="concordance-summary",
                            body=(
                                "This panel displays who led concordance moments and the distribution of concordance strength ",
                                "from the recorded session. The top bar chart indicates how many times each participant led a concordant",
                                " moment in both low and high-frequency concordance (with a cutoff magnitude of 0.5). If there is no data for a participant, it means",
                                " they did not lead a concordance for that frequency. Clicking on a participant's bar will filter ",
                                "the visuals for percent of time in joint engagement and concordance magnitude distributions by concordances (low or high) led by the selected participant.",
                                " Clicking again will remove the filter.",
                            ),
                    ),
            ...
            html.Div(
                ...
                children=[
                    chart_header(
                            ...
                            body=(
                                "The dual radial bar charts depict the magnitude of low frequency concordance and high ",
                                "frequency concordance at each second in the video. The time at which the data is displayed is updated by navigating or playing the video.  ",
                                " Both the length and color of the bars indicate the magnitude of concordance - short, lighter bars represent a lack of concordance, bars that reach a bluish tint ",
                                "at the midway point represent weaker concordance, and very long bars reaching a deep purple represent stronger concordance. "
                            ),
                    ),
                ...
                children=[
                    chart_header(
                            ...
                            body=(
                                ...
                                " and displays what type of engagement (if any) is occurring at the selected time. The right icon under Leading Phsyicologic Concordance is ",
                                " coordinated to the 'Leading' heatmap and indicates whether the parent or child is leading the interaction at that moment."
                            ),
                    ),
                    html.Div(
                    ...
                    children=[
                        ...
                        html.Div(
                            ...
                            style={
                                **TAB_BASE_STYLE,
                                ...
                                "color": "#ffffff",           # text color matches highlighted icon
                            },
                            children=[
                                html.Img(
                                    id="tab-home-icon",
                        ...
                        html.Div(
                            ...
                            style={
                                **TAB_BASE_STYLE,
                                "backgroundColor": "white",
                                "color": "#333333",          # text color matches non-highlight icon
                            },
                            children=[
                                html.Img(
                                    id="tab-play-icon",
...
def switch_tab(home_clicks, play_clicks, pit_value):
    ...
    # PIT toggle: value is [] or ['pit']
    show_pit = "pit" in (pit_value or [])

    active_tab_extra = {
        "backgroundColor": "#333",
        "color": "#ffffff",      # matches highlighted svg
    }
    inactive_tab_extra = {
        "backgroundColor": "white",
        "color": "#333333",      # matches regular svg stroke color
    }
...
def filter_by_leader(click_data, time_window, current_filter):
    ...
    if new_filter in ["Child", "Parent"]:
        ...
        leading_fig.update_layout(
            title=f"Moments of Concordance Led by Each Participant ({selected} leading only)"
        )
    else:
        for trace in leading_fig.data:
            trace.update(marker=dict(opacity=1.0))
...
def update_glyph_from_video(current_time):
    ...
    # Map video time (seconds) to absolute timestamp from our data
    ...
    if pos <= 0: # we’re before or at the first timestamp
        i0 = i1 = 0
    elif pos >= len(TS_SERIES): # we’re after the last timestamp
...
def nav_from_heatmap_click_or_hover(clickData, hoverData, highlight_mode, current_fig):
    ...
    if not ctx.triggered:
        # don't overwrite the layout's initial figure
        raise PreventUpdate
