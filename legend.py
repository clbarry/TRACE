...
SYNCH_COLORS = px.colors.sequential.BuPu  # Plotly BuPu scale
...
def make_combined_legend():
    ...
    # Coherence gradient (left column)
    n_steps = 60
    ...
    leader_labels = [
        "Parent Leading Concordance",
        "Child Leading Concordance",
    ]
    leader_colors = [
        LEAD_COLORS["Parent"],
        LEAD_COLORS["Child"],
